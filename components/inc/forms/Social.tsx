    ...
    <form className="mt-4 space-y-2.5" onSubmit={onSubmit}>
      ...
      <Input
        ...
        register={register("facebook", {
          required: "facebook user url required",
        })}
        id="facebook"
      />
      ...
      <Input
        ...
        register={register("instagram", {
          required: "instagram user url required",
        })}
        id="instagram"
      />
      ...
      <Input
        ...
        register={register("twitter", {
          required: "twitter user url required",
        })}
        id="twitter"
      />
      ...
      <Input
        label="Interest"
        register={register("interest", { required: "interests are required" })}
        id="interest"
      />
