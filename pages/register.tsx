            ...
            <div
                ...
                <form className="flex flex-col pt-3 md:pt-8">
                    ...
                    <div className="flex justify-items-center">
                        <button type="submit"
                                className="rounded-2xl h-12 px-4 py-2 text-base capitalize font-semibold text-center text-white transition duration-200 ease-in bg-primaryColor shadow-md hover:text-black hover:bg-white focus:outline-none focus:ring-2 w-full">
